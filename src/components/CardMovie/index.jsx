  ...
  return (
    <div className="flex flex-col gap-3 max-w-[300px]">
      <div className="relative">
        <div className="static bg-gray-400 w-full aspect-[3/4] rounded-lg overflow-hidden">
          <Image
        ...
        <div className="absolute bottom-0 w-full p-2 flex justify-between">
          <Badge>
            <RateIcon className="text-amber-500 text-3xl" />
            <p className="text-amber-500 subtitle-1">{rating}</p>
          </Badge>

          {isAdult && (
            <Badge>
              <MatureIcon className="text-amber-500 text-3xl" />
            </Badge>
          )}
        </div>
      </div>
